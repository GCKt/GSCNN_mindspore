...
class AtrousSpatialPyramidPoolingModule(nn.Cell):
    ...
    def __init__(self, in_dim, reduction_dim=256, output_stride=16, rates=[6, 12, 18]):
        ...
        self.features.append(
            nn.SequentialCell(nn.Conv2d(in_dim, reduction_dim, kernel_size=1, has_bias=False, weight_init="XavierUniform"),
                          Norm2d(reduction_dim), nn.ReLU()))
        # other rates
        for r in rates:
            self.features.append(nn.SequentialCell(
                nn.Conv2d(in_dim, reduction_dim, kernel_size=3,
                          dilation=r, has_bias=False, weight_init="XavierUniform"),
        ...
        self.img_conv = nn.SequentialCell(
            nn.Conv2d(in_dim, reduction_dim, kernel_size=1, has_bias=False, weight_init="XavierUniform"),
            Norm2d(reduction_dim), nn.ReLU())
        self.edge_conv = nn.SequentialCell(
            nn.Conv2d(1, reduction_dim, kernel_size=1, has_bias=False, weight_init="XavierUniform"),
            Norm2d(reduction_dim), nn.ReLU())
...
class GSCNN(nn.Cell):
    ...
    def __init__(self, num_classes, trunk=None, criterion=None):
        ...
        self.dsn3 = nn.Conv2d(256, 1, 1, weight_init="XavierUniform")
        self.dsn4 = nn.Conv2d(512, 1, 1, weight_init="XavierUniform")
        self.dsn7 = nn.Conv2d(4096, 1, 1, weight_init="XavierUniform")

        self.res1 = Resnet.BasicBlock(64, 64, stride=1, downsample=None)
        self.d1 = nn.Conv2d(64, 32, 1, weight_init="XavierUniform")
        self.res2 = Resnet.BasicBlock(32, 32, stride=1, downsample=None)
        self.d2 = nn.Conv2d(32, 16, 1, weight_init="XavierUniform")
        self.res3 = Resnet.BasicBlock(16, 16, stride=1, downsample=None)
        self.d3 = nn.Conv2d(16, 8, 1, weight_init="XavierUniform")
        self.fuse = nn.Conv2d(8, 1, kernel_size=1, padding=0, has_bias=False, weight_init="XavierUniform")

        self.cw = nn.Conv2d(2, 1, kernel_size=1, padding=0, has_bias=False, weight_init="XavierUniform")
        ...
        self.bot_fine = nn.Conv2d(128, 48, kernel_size=1, has_bias=False, weight_init="XavierUniform")
        self.bot_aspp = nn.Conv2d(1280 + 256, 256, kernel_size=1, has_bias=False, weight_init="XavierUniform")

        self.final_seg = nn.SequentialCell(
            nn.Conv2d(256 + 48, 256, kernel_size=3, has_bias=False, weight_init='XavierUniform'),
            Norm2d(256),
            nn.ReLU(),
            nn.Conv2d(256, 256, kernel_size=3, has_bias=False, weight_init='XavierUniform'),
            Norm2d(256),
            nn.ReLU(),
            nn.Conv2d(256, num_classes, kernel_size=1, has_bias=False, weight_init='XavierUniform'))
    ...
    def construct(self, inp, mask, edgemap, newcanny, gts=None):
        ...
        # else:
        # loss = JointEdgeSegLoss(classes=20, ignore_index=255,
        #                         upper_bound=1.0,
